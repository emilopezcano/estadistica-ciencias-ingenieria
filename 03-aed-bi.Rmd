...
La expresión general $R^2 = 1- \frac{s_\varepsilon^2}{s_y^2}$ es válida para cualquier modelo de regresión en el que podamos calcular los residuos y su varianza. Pero la equivalencia $R^2=r^2$ solo solo es válida en el caso de la regresión lineal simple.
...
```{r reglab, echo = FALSE, fig.height=4, fig.align='center', out.width="55%", fig.cap="Recta de regresión del extracto seco frente a la materia grasa"}
...
çejemplo binarias (regresión logística) o de recuentos (regresión de Poisson).
