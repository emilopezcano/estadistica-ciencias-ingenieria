...
```{r histos, echo=FALSE, fig.cap="Procesos con la misma media y distinta variabilidad", purl=FALSE, fig.width=6, fig.asp=0.6, fig.align='center', out.width="100%"}
...
```{r spc, echo=FALSE, fig.cap="Gráficos de control y capacidad del proceso", purl=FALSE, fig.width=6, fig.asp=0.6, fig.align='center', out.width="100%"}
