...
distribución normal estándar $Z\sim N(0;1)$, es decir $F(z)=P[Z\leq z]$,
para $z>0$. Recuerda que por simetría $P[Z\le -z] = 1- P[Z \le z]$.
\end{minipage}%
\hfill
...
#| fig-width: 4
#| fig-height: 3
par(mgp = c(1, 0.4, 0), cex.axis = 0.6)
...
colnames(tm)[1] <- "z"
knitr::kable(tm, row.names = FALSE, format = "latex", booktabs = TRUE, linesep = "") |>
  kableExtra::kable_styling(font_size = 11, latex_options = c("hold_position", "scale_down"))
```
