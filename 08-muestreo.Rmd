...
```{r, fig.height=4, fig.align='center', out.width="60%", echo=FALSE}
mu <- 0
sig <- 1
a <- -1.96
b <- -5
...
`r emo::ji("bulb")` Dependiendo de la combinación, se utiliza una fórmula u otra
...
`r emo::ji("bulb")` Aproximación de Welch
...
`r emo::ji("bulb")` O lo que es lo mismo, las diferencias observadas en las **muestras** son debidas al azar, y no a una diferencia real entre los parámetros poblacionales.
